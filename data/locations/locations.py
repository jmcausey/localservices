us_cities_geo = {
    # Top 100 US Cities & State Capitals & Top 20 Texas Cities
    ...
    "Spokane, WA": (47.6588, -119.4260), # Spokane approx
    ...
    "Aurora, IL": (41.7661, -88.3073),
    "Montgomery, AL": (32.3668, -86.3006),
